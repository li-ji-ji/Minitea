...
<div class="container">
	<form role="form" action="/pic/add" method="post">
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" name="picName" id="picName" placeholder="请输入菜单名称">
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" readonly class="form-control" name="picUrl" id="picUrl" placeholder="图片地址">
	  </div>
	  <input type="hidden" readonly class="form-control" name="picKey" id="picKey" placeholder="图片键名">
	  <div class="form-group">
	    <label for="menuSort">图片状态</label>
	    <input type="number" class="form-control" name="picStatus" id="picStatus" placeholder="请输入图片状态">
	  </div>
	  <div class="form-group">
	    <label for="menuStatus">图片宽度</label>
	    <input type="number" class="form-control" name="picWidth" id="picWidth" placeholder="请输入图片宽度">
	  </div>
	  <div class="form-group">
	    <label for="menuImg">图片高度</label>
	    <input type="text" class="form-control" name="picHeight" id="picHeight" placeholder="请输入图片高度">
	  </div>
	  <div class="form-group">
	    <label for="menuIntro">图片描述</label>
	    <textarea class="form-control" name="picIntro" id="picIntro" rows="3"></textarea>
	  </div>
...
<script type="text/javascript">
	...
	$('#picUpload').fileinput({
		...
		$("#picKey").attr('value',data.response.fileName)
	})
